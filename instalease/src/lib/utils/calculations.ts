 ...
 * 
 * Utility functions for calculating installment plans, totals, and discounts.
 * 
 ...
 * @returns {Array<{installmentNumber: number, dueDate: Date, amountDue: number, principal: number, interest: number, remainingBalance: number}>} Installment schedule
 */
